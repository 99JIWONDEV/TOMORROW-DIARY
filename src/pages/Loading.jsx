  ...
  return (
    <div className="Loading">
      <div className="LoadingDate">
        {sessionStorage.getItem("year")}년 {sessionStorage.getItem("month")}월 {sessionStorage.getItem("day")}일
      </div>
      <div className="LoadingDesc">
        {sessionStorage.getItem("nickname")}님과 같은 감정을 <br />
        기대하는 사람이 <span>{number}</span>명이 있습니다
      </div>
    </div>
  );
};
